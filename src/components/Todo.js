...
export default function Todo({ data, setData }) {
    ...
    return (
        <div className="flex justify-center flex-col items-center bg-purple-200">
            <div className="grow shrink-0 w-[500px] ">
                <div className="pt-5">
                    <div className="text-lg font-bold bg-purple-200">Todos
                    </div>
                    ...
                    {todo.isEditing ? (
                        <button onClick={updateClicked} className="mt-3 shadow bg-purple-200 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Update
                        </button>
                    ) : (
                        <button onClick={buttonClicked} className="mt-3 shadow bg-pink-500 hover:bg-purple-250 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Add todo
                        </button>
                    )}
                </div>
                        ...
                        if (todo.isDone !== true) {
                            return (
                                ...
                                <li className="text-lg pt-5 flex" key={index}>
                                    ...
                                    <div>
                                        <button onClick={() => doneClicked(index)} className="mt-3 mr-4 shadow bg-green-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                                            Done
                                        </button>
